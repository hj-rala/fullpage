    ...
    e.fn.fullpage = function(s) {
        ...
        function pe(e, n) {
            if (Jn.m[e]) {
                ...
                if ("down" == e ? (o = "bottom", t = Dn.moveSectionDown) : (o = "top", t = Dn.moveSectionUp), n.length > 0) {
                    if (!s.scrollOverflowHandler.isScrolled(o, n))
                        return !0;
                    t()
                } else
                    t()
        ...
        function je(n, o) {
            ...
            if (s.onSlideLeave) {
                var p = u.index(),
                    v = tn(p, r);
                if (!h && "none" !== v && e.isFunction(s.onSlideLeave) && s.onSlideLeave.call(u, c, l + 1, p, v, r) === !1)
                    return void (Wn = !1)
            }
        ...
        function Qe() {
            if (Ge(), Yn) {
                ...
                clearTimeout(Zn), Zn = setTimeout(function() {
                    Dn.reBuild(!0)
                }, 350)
        }
        function Ge() {
